...
export default ({ width, height, native }) =>
  <Svg width={width} height={height} viewBox="0 0 4000 2000" version="1.1">
    <Rect x="5" y="5" width="3990" height="1990" fill="none" stroke="blue" strokeWidth="10"/>

    <G fill="blue" stroke="red" fontFamily="Verdana" fontSize={150}>
        ...
        <G transform="translate(1600,0)">
            ...
            <G transform="scale(2)">
                <Rect x="0" y="600" width="2.5em" height="1.25em" strokeWidth=".25em"/>
            </G>
        </G>
